...
import type { module5d } from "./store/module5d";
...
const mdiFileDocumentLock =
  "M12 21.7V18H6v-2h6.9l.3-.3v-.2q0-.75.3-1.5H6v-2h9.1c.8-.6 1.8-1 2.9-1 .7 0 1.4.2 2 .4V8l-6-6H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h6zm1-18.2L18.5 9H13ZM20.8 17v-1.5c0-1.4-1.4-2.5-2.8-2.5s-2.8 1.1-2.8 2.5V17c-.6 0-1.2.6-1.2 1.2v3.5c0 .7.6 1.3 1.2 1.3h5.5c.7 0 1.3-.6 1.3-1.2v-3.5c0-.7-.6-1.3-1.2-1.3m-1.3 0h-3v-1.5c0-.8.7-1.3 1.5-1.3s1.5.5 1.5 1.3z";
/**
...
export const Globals = Object.freeze({
  ...
  CONFIG_SERVICE_MAP: [
    ...
    { filename: "webcam.txt", service: "webcamd" },
    {
      ...
      service: "crowsnest",
      link: "https://crowsnest.mainsail.xyz/configuration/sample-config",
    },
    {
      filename: "klipperscreen.conf",
      service: "KlipperScreen",
      link: "https://klipperscreen.readthedocs.io/en/latest/",
    },
    { filename: "sonar.conf", service: "sonar", link: "https://github.com/mainsail-crew/sonar" },
    {
      filename: "mooncord-webcam.json",
      service: "webcamd",
      link: "https://github.com/eliteSchwein/mooncord",
    },
    { prefix: "mooncord", service: "MoonCord", link: "https://github.com/eliteSchwein/mooncord" },
    {
      filename: "telegram.conf",
      service: "moonraker-telegram-bot",
      link: "https://github.com/nlef/moonraker-telegram-bot/wiki/Sample-config",
    },
...
export const SupportedMarkdownFormats = Object.freeze([".markdown", ".md", ".mdown"]);

export const SupportedVideoFormats = Object.freeze([".mp4", ".mpeg", ".mpg"]);
